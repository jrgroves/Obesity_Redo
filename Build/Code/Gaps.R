#Creates the "unemployment gaps files for the NLSY data set from 1980 to 2004
#By Jeremy Groves
#January 6, 2021
...
gaps <- function(x) {
  ...
  temp<-data.frame(ID,j1s,j1e,j1ten,j1r,j1o,j1t,j1c,j1hr,j1cb,j1nj,
                   j2s,j2e,j2ten,j2r,j2o,j2t,j2c,j2hr,j2cb,j2nj,j3s,j3e,j3ten,j3r,j3o,j3t,j3c,j3hr,j3cb,j3nj,
                   j4s,j4e,j4ten,j4r,j4o,j4t,j4c,j4hr,j4cb,j4nj,j5s,j5e,j5ten,j5r,j5o,j5t,j5c,j5hr,j5cb,j5nj)
  ...
  df1<-subset(temp,select=c(ID,gap5,j5ten:j5nj))
    df1<-df1[!is.na(df1$gap5),]
    names(df1)<-c("ID","gap","ten","reason","occ","type","class","rate","union","newjob")
  df2<-subset(temp,select=c(ID,gap4,j4ten:j4nj))
    df2<-df2[!is.na(df2$gap4),]
    names(df2)<-c("ID","gap","ten","reason","occ","type","class","rate","union","newjob")
  df3<-subset(temp,select=c(ID,gap3,j3ten:j3nj))
    df3<-df3[!is.na(df3$gap3),]
    names(df3)<-c("ID","gap","ten","reason","occ","type","class","rate","union","newjob")
  df4<-subset(temp,select=c(ID,gap2,j2ten:j2nj))
    df4<-df4[!is.na(df4$gap2),]
    names(df4)<-c("ID","gap","ten","reason","occ","type","class","rate","union","newjob")
...
nj<-read.csv("./Build/Input/default.csv", header=TRUE, as.is=TRUE)
  names(nj)<-gsub("R","r",names(nj))
...
data<-read.dta("./Build/Input/nls1980.dta")
  ...
  data<-merge(data,nj,by="r0000100",all.x=TRUE)
    names(data)<-gsub(".x","",names(data))
...
elements<-c("r0000100","r0332700","r0332710","r0332720","r0333200","r0333210","r0333220","r0333221","r0333300",
            ...
            "r0362200","r0373700","r0385200","r0333400","r0344900","r0356400","r0367900","r0379400")
...
elements<-c("r0000100","r0538800","r0538900","r0539000","r0539200","r0539300","r0539400","r0539410","r0539500",
            ...
            "r0573100","r0586200","r0599300","r0539600","r0552700","r0565800","r0578900","r0592000")
...
elements<-c("r0000100","r0833200","r0833300","r0833400","r0833600","r0833700","r0833800","r0833810","r0833900",
            ...
            "r0867400","r0880500","r0893600","r0834000","r0847100","r0860200","r0873300","r0886400")
...
elements<-c("r0000100","r1080400","r1080500","r1080600","r1080800","r1080900","r1081000","r1081010","r1081100",
            ...
            "r1114900","r1128100","r1141300","r1081200","r1094400","r1107600","r1120800","r1134000")
...
elements<-c("r0000100","r1456100","r1456200","r1456300","r1456500","r1456600","r1456700","r1456710","r1456800",
            ...
            "r1490400","r1503500","r1516600","r1456900","r1470000","r1483100","r1496200","r1509300")
...
elements<-c("r0000100","r1802900","r1803000","r1803100","r1803300","r1803400","r1803500","r1803510","r1803600",
            ...
            "r1836400","r1849100","r1861800","r1803700","r1816400","r1829100","r1841800","r1854500")
...
elements<-c("r0000100","r2164500","r2164600","r2164700","r2164900","r2165000","r2165100","r2165110","r2165200",
            ...
            "r2200700","r2214300","r2227900","r2165400","r2179000","r2192600","r2206200","r2219800")
...
elements<-c("r0000100","r2371900","r2372000","r2372100","r2372300","r2372400","r2372500","r2372510","r2372600",
            ...
            "r2401100","r2412400","r2423700","r2372800","r2384100","r2395400","r2406700","r2418000")
...
elements<-c("r0000100","r2762800","r2762900","r2763000","r2763200","r2763300","r2763400","r2763410","r2763500",
            ...
            "r2799000","r2811900","r2824800","r2764400","r2777300","r2790200","r2803100","r2816000")
...
elements<-c("r0000100","r3004600","r3004700","r3004800","r3005000","r3005100","r3005200","r3005210","r3005300",
            ...
            "r3041300","r3054400","r3067500","r3006200","r3019300","r3032400","r3045500","r3058600")
...
elements<-c("r0000100","r3332000","r3332100","r3332200","r3332400","r3332500","r3332600","r3332610","r3332700",
            ...
            "r3371900","r3385900","r3399900","r3333600","r3347600","r3361600","r3375600","r3389600")
...
elements<-c("r0000100","r3597000","r3597100","r3597200","r3597400","r3597500","r3597600","r3597610","r3597700",
            ...
            "r3631200","r3643300","r3655400","r3597900","r3610000","r3622100","r3634200","r3646300")
...
elements<-c("r0000100","r3947100","r3947200","r3947300","r3947500","r3947600","r3947700","r3947800","r3947900",
            ...
            "r3981600","r3993800","r4006000","r3948100","r3960300","r3972500","r3984700","r3996900")
...
elements<-c("r0000100","r4187800","r4187801","r4187802","r4440300","r4440301","r4440302","r4416300","r4188000",
            ...
            "r4214800","r4222400","r4229600","r4188200","r4201100","r4208700","r4215700","r4223300")
